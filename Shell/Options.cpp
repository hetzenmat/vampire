...
//*********************** Saturation  ***********************
    ...
    _numClauseFeatures.onlyUsefulWith(Or(_showPassiveTraffic.is(notEqual(false)),_neuralPassiveClauseContainer.is(notEqual(vstring("")))));
    ...
    _neuralPassiveClauseContainerTweaks.onlyUsefulWith(_neuralPassiveClauseContainer.is(notEqual(vstring(""))));
