...
KBO kbo_greater(const Map<unsigned, KboWeight>& funcs, const Map<unsigned, KboWeight>& preds) {
  return kbo(funcs, preds, true);
}
...
TEST_FUN(kbo_isGreater_test01) {
  ...
  auto ord = kbo_greater(weights(make_pair(f, 10u), make_pair(c, 1u)), weights());
...
TEST_FUN(kbo_isGreater_test02) {
  ...
  auto ord = kbo_greater(weights(make_pair(f, 10u)), weights());
...
TEST_FUN(kbo_isGreater_test05) {
  ...
  auto ord = kbo_greater(weights(make_pair(f, 0u)), weights());
...
TEST_FUN(kbo_isGreater_test07) {
  ...
  auto ord = kbo_greater(weights(make_pair(f, 0u), make_pair(g, 1u)), weights());
...
TEST_FUN(kbo_isGreater_test09) {
  ...
  auto ord = kbo_greater(weights(), weights());
...
TEST_FUN(kbo_isGreater_test10) {
  ...
  auto ord = kbo_greater(weights(make_pair(a,3u), make_pair(b,2u)), weights());
...
TEST_FUN(kbo_isGreater_test11) {
  ...
  auto ord = kbo_greater(weights(make_pair(a,1u), make_pair(u,0u)), weights());
