...
public:
  ...
  virtual VirtualIterator<QueryRes<ResultSubstitutionSP, Data>> getHOLUnifiers(TypedTermList t) { THROW_MH(); }
  virtual VirtualIterator<QueryRes<ResultSubstitutionSP, Data>> getHOLInstances(TypedTermList t, bool retrieveSubstitutions = true) { THROW_MH(); }
  virtual VirtualIterator<QueryRes<ResultSubstitutionSP, Data>> getHOLGeneralizations(TypedTermList t) { THROW_MH(); }
