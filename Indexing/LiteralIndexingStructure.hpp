...
public:
  ...
  virtual VirtualIterator<QueryRes<ResultSubstitutionSP, LeafData>> getHOLGeneralizations(Literal* lit, bool complementary, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
  virtual VirtualIterator<QueryRes<ResultSubstitutionSP, LeafData>> getHOLInstances(Literal* lit, bool complementary, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
